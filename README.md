...
| <div style="width:33%"><img src="screenshots\1_raw.jpg" style="zoom:33%;" />1. Original image (compressed) | <div style="width:33%"><img src="screenshots\2_slices.png" style="zoom:33%;" />2. Image enhancement <br />+ slice determination</div> | <div style="width:33%"><img src="screenshots\3_slice.png" style="zoom:33%;" />3. Individual slice analysis</div> |
| :----------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
