...
| <img src="screenshots\1_raw.jpg" style="zoom:33%;" />1. Original image (compressed) | <img src="screenshots\2_slices.png" style="zoom:33%;" />2. Image enhancement <br />+ slice determination | <img src="screenshots\3_slice.png" style="zoom:33%;" />3. Individual slice analysis |
| :----------------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src="screenshots\4_sliceanalysis.png" style="zoom:33%;" />4. Spectrum normalization<br />+ smoothing + peak detection | <img src="screenshots\5_modelfitting.png" style="zoom:33%;" />5. Extrema-extrema model fitting | <img src="screenshots\6_sliceheight.png" style="zoom:33%;" />6. Stitched height profile for one slice |
